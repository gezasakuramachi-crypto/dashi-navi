...
for (const page of ["schedule/index.html", "schedule/9-2.html", "schedule/9-3.html"]) {
  ...
  assert.match(html, /schedule\.css\?v=20260820-1/);
  assert.match(html, /schedule\.js\?v=20260820-1/);
...
assert.match(schedule, /data-ad-rotator/);
assert.match(schedule, /\.\.\/mark\/ads\/koken-640x100\.png/);
assert.match(schedule, /https:\/\/www\.koken-realestate\.com\//);
